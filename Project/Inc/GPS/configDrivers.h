...
#define ITSDK_DRIVERS_GNSS_QUECTEL_NRESET_BANK        GPS_RST_GPIO_Port                    // Pin to control the quectel GNSS Reset signal
#define ITSDK_DRIVERS_GNSS_QUECTEL_NRESET_PIN         GPS_RST_Pin                    //    __LP_GPIO_NONE if not used
