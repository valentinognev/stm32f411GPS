...
gnss_ret_e gnss_delTriggerCallBack(gnss_eventHandler_t * handler);
gnss_ret_e gnss_addTriggerCallBack(gnss_eventHandler_t * handler);
bool gnss_isTriggerCallBack(gnss_eventHandler_t * handler);
