...
#define    LCD_CS_SET       LL_GPIO_SetOutputPin(LCD_CS_GPIO_Port,LCD_CS_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_SET)         //PB12 Set 1  
#define    LCD_RST_SET      LL_GPIO_SetOutputPin(LCD_RST_GPIO_Port,LCD_RST_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_SET)       //PB14 Set 1 
#define    LCD_RS_SET       LL_GPIO_SetOutputPin(LCD_RS_GPIO_Port,LCD_RS_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_SET)           //PB1 Set 1  
...
#define    LCD_CS_CLR       LL_GPIO_ResetOutputPin(LCD_CS_GPIO_Port,LCD_CS_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_12,GPIO_PIN_RESET)         //PB12 Set 1  
#define    LCD_RST_CLR      LL_GPIO_ResetOutputPin(LCD_RST_GPIO_Port,LCD_RST_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_14,GPIO_PIN_RESET)       //PB14 Set 1 
#define    LCD_RS_CLR       LL_GPIO_ResetOutputPin(LCD_RS_GPIO_Port,LCD_RS_Pin)   //HAL_GPIO_WritePin(GPIOB,GPIO_PIN_1,GPIO_PIN_RESET)           //PB1 Set 1  
