 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevReadReg8(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevReadReg16(I2cDrv *dev, uint8_t devAddress, uint16_t memAddress,
               uint16_t len, uint8_t *data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevReadByte(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
                    uint8_t *data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevReadBit(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevReadBits(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
 ...
 */
bool i2cdevWrite(I2cDrv *dev, uint8_t devAddress, uint16_t len, uint8_t *data);
 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
bool i2cdevWriteReg8(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
                 uint16_t len, uint8_t *data);
 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
bool i2cdevWriteReg16(I2cDrv *dev, uint8_t devAddress, uint16_t memAddress,
                   uint16_t len, uint8_t *data);
 ...
 * @return TRUE if write was successful, otherwise FALSE.
 */
bool i2cdevWriteByte(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
                     uint8_t data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevWriteBit(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
                    uint8_t bitNum, uint8_t data);
 ...
 * @return TRUE if read was successful, otherwise FALSE.
 */
bool i2cdevWriteBits(I2cDrv *dev, uint8_t devAddress, uint8_t memAddress,
                     uint8_t bitStart, uint8_t length, uint8_t data);
